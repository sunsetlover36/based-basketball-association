...
export const TeamPlayer = () => {
  ...
  const isCoach = user?.address === address;
  ...
  const trainingDisabled =
    !isLastTrainingEnded || !isCoach || traits.stamina < 50;
        ...
        <div>
          <div className="flex mb-4">
            ...
            <div className="w-2/3">
              ...
              {(lastTraining && !isLastTrainingEnded ? true : isCoach) && (
                <div>
                    ...
                    <div className="flex items-center">
                      ...
                      {!isCoach && address && (
                        <div className="relative">
                          {user?.team &&
                            accountAddress &&
                            !lastTraining.fans.includes(user.address) &&
                            !isCheered && (
                              <Button
